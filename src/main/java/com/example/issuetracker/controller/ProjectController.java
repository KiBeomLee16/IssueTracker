...
public class ProjectController {
	...
	public ResponseEntity<ApiResponse<ProjectStatsResponse>> getProjectStats(@PathVariable Long projectId) {
		ProjectStatsResponse response = projectService.getProjectStats(projectId);

		return ResponseEntity.ok(ApiResponse.success("Project stats retrieved successfully.", response));
	}
